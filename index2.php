...
<html>
<head>
  <title>Mapservice | Coffee Squad</title>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
  <link href="/income/css/btp/bootstrap.min.css" rel="stylesheet">
  <link href="/income/css/hell.css" rel="stylesheet">
  <link href="/income/css/main.css" rel="stylesheet">

  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.3/umd/popper.min.js" integrity="sha384-vFJXuSJphROIrBnz7yo7oB41mKfc8JzQZiCq4NCceLEaO4IHwicKwpJf9c9IpFgh" crossorigin="anonymous"></script>
  <script src="/income/js/btp/bootstrap.min.js" type="text/javascript"></script>

  <link href="/income/css/hell.css" rel="stylesheet">
  <link href="/income/css/preload.css" rel="stylesheet">
  <script src="/income/js/hello.js"></script>
  <script type="text/javascript">
    var loaded_map_height = 0;
  </script>
...
<header>
  <nav class="navbar navbar-dark fixed-top bg-dark">
    ...
    <div>
      <a class="btn btn-outline-success my-2 my-sm-0" href="">Экспорт</a>
      <button class="btn navbar-btn btn-outline-warning" data-toggle="modal" data-target="#add-modal">Добавить точку</button>
      <a class="btn btn-outline-danger my-2 my-sm-0" href="">Выход</a>
    </div>
  </nav>
</header>
  ...
  <p class="email">emailof_person@gmail.com</p>
   ...
   $('.dropdown').click(function(){
    $('.dropdown-menu').toggleClass('show');
                ...
                <div id="left2">
            <li class="nav-item">
              <svg style="position:relative; bottom: 10px; left: 10px;" width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-wallet2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<a style="position: relative; left: 30px; bottom: 45px;" class="nav-link" href=""><h5 style="font-size: 105%" ;="">Budget</h5></a>
            </li>
          </div>
          <div id="left3">
            <li class="nav-item">
              <svg style="position:relative; bottom: 20px; left: 10px;" width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-graph-up" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M0 0h1v15h15v1H0V0zm10 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-1 0V4.9l-3.613 4.417a.5.5 0 0 1-.74.037L7.06 6.767l-3.656 5.027a.5.5 0 0 1-.808-.588l4-5.5a.5.5 0 0 1 .758-.06l2.609 2.61L13.445 4H10.5a.5.5 0 0 1-.5-.5z"></path>
              ...
              <a style="position: relative; left: 30px; bottom: 55px;" class="nav-link" href=""><h5 style="font-size: 105%">Reports</h5></a>
            </li>
            </div>
            <div id="left4">
            <li class="nav-item">
              <svg style="position:relative; bottom: 40px; left: 10px; bottom: 5px;" width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-layers-half" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" d="M7.765 1.559a.5.5 0 0 1 .47 0l7.5 4a.5.5 0 0 1 0 .882l-7.5 4a.5.5 0 0 1-.47 0l-7.5-4a.5.5 0 0 1 0-.882l7.5-4zM1.563 6L8 9.433 14.438 6 8 2.567 1.562 6z"></path>
              ...
              <a style="position: relative; left: 27px; bottom: 40px;" class="nav-link" href=""><h5 style="font-size: 105%">All accounts</h5></a>
            </li>
            </div>
          </ul>
          <div id="account">
  ...
  <table style="width: 1200px; position: relative; right: 1px; top: 55px; background:red" class="table">
<thead class="thead-dark">
<tr>
<th scope="col">Total</th>
<th scope="col"><input type="text" class="number_main" placeholder="$0.00"></th>
<th scope="col"><input type="text" class="number" placeholder="$0.00"></th>
<th scope="col"><input type="text" class="number" placeholder="$0.00"></th>
<th scope="col"><input type="text" class="number" placeholder="$0.00"></th>
<th scope="col"><input type="text" class="number" placeholder="$0.00"></th>
</tr>
          ...
          <h1 style="position: relative; left: 100px; bottom: 100px;">Oct 2020</h1>
          <a href="#"><svg style="position: relative; left: 260px; bottom: 170px;" width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-arrow-right-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"></path>
  ...
  $('.number_main').text(sum);</script>
    ...
    <tbody>
      <tr>
        ...
        <td><input type="text" class="food" placeholder="$0.00"></td>
        <td><input type="text" class="products" placeholder="$0.00"></td>
        <td><input type="text" class="house" placeholder="$0.00"></td>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-md-4 col-12">
                    <div class="edit-photo-holder card">
                      <img class="edit-photo-img card-img-top rounded mx-auto d-block" src="/img/no-photo.png">
                ...
                <div class="row">
                 ...
                 <div class="form-group">
                   ...
                   <table width="100%">
                     <tr><th>День недели</th><th>С</th><th>До</th></tr>
